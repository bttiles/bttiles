...
export default function LocalBusinessStructuredData() {
  const structuredData = {
    ...
    description:
      "Pakistan's #1 tuff tiles manufacturer. Bismillah Tuff Tiles Karachi produces premium quality tuff tiles, pavers, and construction materials with nationwide delivery.",
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Premium quality tuff tiles for residential and commercial use",
          },
        },
        {
          "@type": "Offer",
        ...
        },
        {
          ...
          itemOffered: {
            ...
            category: "Construction Materials",
            description:
              "Decorative GRC jali patterns for architectural designs",
          },
        },
      ],
    },
    makesOffer: {
      ...
      description:
        "Premium tuff tiles manufacturing and nationwide delivery across Pakistan",
      areaServed: "Pakistan",
