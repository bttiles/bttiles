  ...
  try {
    ...
    if (!texture) {
      return genMeta({
        ...
        description:
          "The requested texture could not be found. Browse our collection of premium tiles and pavers.",
      });
    }
    ...
    return genMeta({
      ...
      description:
        "View detailed information about our premium tiles and construction materials.",
    });
  }
}
