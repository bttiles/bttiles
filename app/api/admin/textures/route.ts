...
export async function GET(request: NextRequest) {
  try {
    ...
    // Get statistics
    const stats = {
      total: await Texture.countDocuments(),
      active: await Texture.countDocuments({ isActive: true }),
      inactive: await Texture.countDocuments({ isActive: false }),
      featured: await Texture.countDocuments({
        featured: true,
        isActive: true,
      }),
      trending: await Texture.countDocuments({
        trending: true,
        isActive: true,
      }),
    };
